# 📋 Quick Copy - Submission Data

**Copy-paste ready untuk API submission**
...
## ⛓️ Solana Integration (Copy This)
...
## 📤 cURL Command (Update YOUR_API_KEY)
...
1. Update `YOUR_API_KEY` dengan API key dari COLOSSEUM-CREDENTIALS.md
2. Update `YOUR_USERNAME` dengan GitHub username
3. Update `presentationLink` dengan YouTube video URL (setelah upload)
4. Test semua links
5. Submit!
